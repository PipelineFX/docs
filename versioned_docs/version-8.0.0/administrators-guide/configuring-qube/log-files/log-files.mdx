...
By default QubeUI will show just the last 250 lines of the supervisor or workerlog,
but this size is configurable via "Preferences &rarr; UI &rarr; Logs &rarr; Display only last N lines of log".

For Job Logs, select the job, right-click, and then select either:

* Open log directory - will open a file browser in the directory where the job logs are stored
* Zip log directory - will open a file browser in the Desktop directory where the zipped job log was saved

## Other Log Topics
* [Job logs](/administrators-guide/configuring-qube/log-files/Job+Logs)
* [Supervisor Logs](/administrators-guide/configuring-qube/log-files/Supervisor+Logs)
* [Worker Logs](/administrators-guide/configuring-qube/log-files/Worker+Logs)
...
* [Log Rotation](/administrators-guide/configuring-qube/log-files/Log+Rotation)
* [Logrotate.py script](/administrators-guide/configuring-qube/log-files/The+Logrotate+Script)
