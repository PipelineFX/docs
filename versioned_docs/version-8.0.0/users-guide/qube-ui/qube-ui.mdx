...
-	[Working with Layouts](/users-guide/qube-ui/Working+with+Layouts)
-	[Panels](./panels)
-	[The Mini Jobs View](/users-guide/qube-ui/Mini+Jobs+View)
-	[Submitting Jobs](/category/submitting-jobs-1)
-	[Preferences](/users-guide/qube-ui/Preferences)
