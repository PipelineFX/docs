...
1. [Event names](/developers-guide/callbacks/triggers/trigger-event-syntax/Event+names)
2. [Event types](/developers-guide/callbacks/triggers/trigger-event-syntax/Event+types)
3. [Event contexts](/developers-guide/callbacks/triggers/trigger-event-syntax/Event+contexts)
4. [Extra fields (only certain context need this)](/developers-guide/callbacks/triggers/trigger-event-syntax/Extra+fields) 
5. [Process group labels](/developers-guide/callbacks/triggers/trigger-event-syntax/Process+group+labels)
