...
You can centrally install these jobtypes on the network fileserver. See the configuration parameter [worker_template_path](../configuration-parameter-reference/worker_template_path) for the search path used by the Workers for their jobtypes.

:::

## See Also

* [Centralized Jobtypes](../configuring-qube/worker-configuration/Centralized+Jobtypes)
* [worker_template_path](../configuration-parameter-reference/worker_template_path)
